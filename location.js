const weatherKey = "dd95da8e4dc391e8425051a143c25098"
// 'Your OpenWeather API KEY Here';
const timeKey = "jaypandey"
// 'Your Geo Name Api Here';

// api calling to whatsapp msg using https://user.ultramsg.com/app/instances/instance.php?id=71821
const token ="p2weodhfujguwwpe"
// 'Your Ultra msg Token Here'
const mobile ="+918709216881"
// "Mobile Number with Country Code"

// const audio = "https://buibuibucket.s3.amazonaws.com/audio/Sunny+Day/Pharrell_Williams_-_Happy_CeeNaija.com_.mp3";
const audio = "https://drive.google.com/file/d/1SLNn6uFXnLDYhJ5OWmDuqenNmfbgBdio/view?usp=sharing"
...
function sendWhatsapp () {
		...
		xhr.open("POST", "https://api.ultramsg.com/instance71821/messages/chat");
...
xhr.open("POST", "https://api.ultramsg.com/instance71821/messages/audio");
xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xhr.send(data);
}
