...
var firstPerson = 'Jay Prakash Pandey'; // Replace with the actual name
var firstLocation = 'Kolkata, India'; // Replace with the actual location

var secondPerson = 'Lucky Roy'; // Replace with the actual name
var secondLocation = 'Motihari, India';
...
var timeLeaveStamp = new Date(2023, 10, 20);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 3, 25);
